          ...
          >
            ...
            <ul className=' justify-content-end'>
              ...
              <li className='nav-item dropdown pe-2 d-flex align-items-center'>
                <a
                  href='https://techfertile.patcognos.com/write-swot'
                  className='nav-link text-body p-0'
                              ...
                              <div className='tox-sidebar-wrap'>
                                <div className='tox-edit-area'>
                                  <iframe
                                    ...
                                    src='./TechFertile-swot-list_files/saved_resource.html'
                                  ></iframe>
                                </div>
                                <div
                                  role='complementary'
                            ...
                            <div className='tox-sidebar-wrap'>
                              <div className='tox-edit-area'>
                                <iframe
                                  ...
                                  title='Rich Text Area. Press ALT-0 for help.'
                                  className='tox-edit-area__iframe'
                                  src='./TechFertile-swot-list_files/saved_resource(1).html'
                                ></iframe>
                              </div>
                          ...
                          >
                            <div className='tox-editor-container'>
                              ...
                              <div className='tox-sidebar-wrap'>
                                <div className='tox-edit-area'>
                                  <iframe
                                    id='opportunities_ifr'
                                    frameBorder='0'
                                    allowtransparency='true'
                                    title='Rich Text Area. Press ALT-0 for help.'
                                    className='tox-edit-area__iframe'
                                    src='./TechFertile-swot-list_files/saved_resource(2).html'
                                  ></iframe>
                                </div>
                                <div
                                  role='complementary'
                            ...
                            <div className='tox-sidebar-wrap'>
                              <div className='tox-edit-area'>
                                <iframe
                                  ...
                                  title='Rich Text Area. Press ALT-0 for help.'
                                  className='tox-edit-area__iframe'
                                  src='./TechFertile-swot-list_files/saved_resource(3).html'
                                ></iframe>
                              </div>
                              <div role='complementary' className='tox-sidebar'>
                                <div
