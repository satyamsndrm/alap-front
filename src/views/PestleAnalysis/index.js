          ...
          >
            ...
            <ul className=' justify-content-end'>
              ...
              <li className='nav-item dropdown pe-2 d-flex align-items-center'>
                <a
                  href='https://techfertile.patcognos.com/write-pestle'
                  className='nav-link text-body p-0'
          ...
          <div className='col-md-12'>
            <div className='card'>
              <div className='card-body'>
                ...
                <form
                  method='post'
                  action='https://techfertile.patcognos.com/save-pestel'
                >
                              ...
                              <div className='tox-sidebar-wrap'>
                                <div className='tox-edit-area'>
                                  <iframe
                                    ...
                                    src='./TechFertile-pestle-list_files/saved_resource.html'
                                  ></iframe>
                                </div>
                                <div
                                  role='complementary'
                            ...
                            <div className='tox-sidebar-wrap'>
                              <div className='tox-edit-area'>
                                <iframe
                                  ...
                                  title='Rich Text Area. Press ALT-0 for help.'
                                  className='tox-edit-area__iframe'
                                  src='./TechFertile-pestle-list_files/saved_resource(1).html'
                                ></iframe>
                              </div>
                              ...
                              <div className='tox-sidebar-wrap'>
                                <div className='tox-edit-area'>
                                  <iframe
                                    ...
                                    title='Rich Text Area. Press ALT-0 for help.'
                                    className='tox-edit-area__iframe'
                                    src='./TechFertile-pestle-list_files/saved_resource(2).html'
                                  ></iframe>
                                </div>
                                <div
                                  role='complementary'
                            ...
                            <div className='tox-sidebar-wrap'>
                              <div className='tox-edit-area'>
                                <iframe
                                  ...
                                  title='Rich Text Area. Press ALT-0 for help.'
                                  className='tox-edit-area__iframe'
                                  src='./TechFertile-pestle-list_files/saved_resource(3).html'
                                ></iframe>
                              </div>
                              <div role='complementary' className='tox-sidebar'>
                                <div
                            ...
                            <div className='tox-sidebar-wrap'>
                              <div className='tox-edit-area'>
                                <iframe
                                  ...
                                  title='Rich Text Area. Press ALT-0 for help.'
                                  className='tox-edit-area__iframe'
                                  src='./TechFertile-pestle-list_files/saved_resource(4).html'
                                ></iframe>
                              </div>
                              <div role='complementary' className='tox-sidebar'>
                                <div
                          ...
                          >
                            <div className='tox-editor-container'>
                              ...
                              <div className='tox-sidebar-wrap'>
                                <div className='tox-edit-area'>
                                  <iframe
                                    id='environmental_ifr'
                                    frameBorder='0'
                                    allowtransparency='true'
                                    title='Rich Text Area. Press ALT-0 for help.'
                                    className='tox-edit-area__iframe'
                                    src='./TechFertile-pestle-list_files/saved_resource(5).html'
                                  ></iframe>
                                </div>
                                <div
                                  role='complementary'
